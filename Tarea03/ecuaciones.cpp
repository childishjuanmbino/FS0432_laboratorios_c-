...
std::vector<double> sumar(std::vector<double> a, std::vector<double> b)
{
...
std::vector<std::vector<double>> r(N, std::vector<double>(3));
	...
	for(int n = 0; n < N-1; n++)
	{
	std::vector<double> k1 = lorenz(r[n], 10, 28, 8.0/3.0);
	std::vector<double> k2 = lorenz(sumar(r[n], rescalar(k1, h/2)), 10, 28, 8.0/3.0);
        r[n+1][0] = r[n][0] + h*k2[0];
        r[n+1][1] = r[n][1] + h*k2[1];
        r[n+1][2] = r[n][2] + h*k2[2];
        }
        return r;
}
...
std::vector<std::vector<double>> r(N, std::vector<double>(3));
        ...
        std::vector<double> k2 = lorenz(sumar(r[n], rescalar(k1, h/2)), 10, 28, 8/3);
	std::vector<double> k3 = lorenz(sumar(r[n], rescalar(k2, h/2)), 10, 28, 8/3);
	std::vector<double> k4 = lorenz(sumar(r[n], rescalar(k3, h)), 10, 28, 8/3);


        r[n+1][0] = r[n][0] + (h/6)*(k1[0] + 2*k2[0] + 2*k3[0] + k4[0]);
        r[n+1][1] = r[n][1] + (h/6)*(k1[1] + 2*k2[1] + 2*k3[1] + k4[1]);
        r[n+1][2] = r[n][2] + (h/6)*(k1[2] + 2*k2[2] + 2*k3[2] + k4[2]);
        }
        return r;
}
